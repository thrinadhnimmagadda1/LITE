      ...
      <div className="relative z-10 py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-16 animate-slideInUp">
            <h1 className="text-7xl font-bold bg-gradient-to-r from-indigo-700 via-violet-700 to-fuchsia-700 bg-clip-text text-transparent mb-4 gradient-text drop-shadow-sm">
              LITE
            </h1>
            ...
            <div className="mt-6">
              <a
                href="#about"
                className="inline-flex items-center space-x-2 px-5 py-2.5 bg-white border border-indigo-200 text-indigo-700 rounded-full shadow-sm hover:shadow-md hover:bg-indigo-50 transition-all duration-300 backdrop-blur-none"
              >
                <span>Learn about LITE</span>
          ...
          {/* Main Search Card */}
          <div className="bg-white rounded-3xl shadow-xl border border-gray-200 p-10 mb-12 card-hover">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold text-slate-800 mb-3">Search Research Papers</h2>
            </div>
          ...
          {searchHistory.length > 0 && (
            <div className="bg-white rounded-3xl shadow-lg border border-gray-200 p-8 card-hover">
